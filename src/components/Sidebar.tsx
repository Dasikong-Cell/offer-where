...
import { AddIcon, DeleteIcon, SettingIcon, UserCircleIcon, ListIcon, SearchIcon } from 'tdesign-icons-react';
    ...
    >
      ...
      <div className="p-3 space-y-1">
        <Button
          ...
          block
          variant={isProfilePage ? 'outline' : 'text'}
          theme={isProfilePage ? 'primary' : 'default'}
        >
          我的档案
        </Button>
        <Button
          ...
          block
          variant={isApplicationsPage ? 'outline' : 'text'}
          theme={isApplicationsPage ? 'primary' : 'default'}
        >
          投递记录
        </Button>
        <Button
          ...
          onClick={onOpenJobs}
          block
          variant={isJobsPage ? 'outline' : 'text'}
          theme={isJobsPage ? 'primary' : 'default'}
        >
          岗位匹配
        </Button>
      </div>
