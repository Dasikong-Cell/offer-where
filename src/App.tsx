...
function App() {
  return (
    <Routes>
      ...
      <Route path="/applications" element={<AppContent />} />
...
function AppContent() {
  ...
  // 从 URL 同步 sessionId
  useEffect(() => {
    const onSubPage = isSettingsPage || isProfilePage || isApplicationsPage || isJobsPage;
    if (urlSessionId && urlSessionId !== currentSessionId) {
      setCurrentSessionId(urlSessionId);
    } else if (!urlSessionId && !onSubPage && currentSessionId) {
      setCurrentSessionId(null);
    }
  }, [urlSessionId, isSettingsPage, isProfilePage, isApplicationsPage, isJobsPage, currentSessionId, setCurrentSessionId]);
  ...
  return (
    ...
    >
      ...
      <Sidebar
        ...
        isApplicationsPage={isApplicationsPage}
