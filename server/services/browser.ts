    ...
    switch (action) {
      ...
      default:
        return {
          ok: false,
          error: `不支持的动作：${action}`,
          hint: '支持：navigate / click / realClick / fill / type / typeHuman / press / select / check / upload / wait / text / html / screenshot / eval / cookies / htmlToPdf / htmlToImage / newTab / adoptPopup / closeTab / closeExtraTabs / reload / bringToFront / close',
        };
    }
  } catch (error: any) {
